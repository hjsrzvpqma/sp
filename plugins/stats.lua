...
local function run(msg, matches)
  if matches[1]:lower() == 'wizard' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "wizard" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (wizard)",-- Put everything you like :)
		"^[!/](wizard)"-- Put everything you like :)
    }, 
  run = run
}
